...
import com.drms.disaster_relief.ngo.NgoDTO;
...
import com.drms.disaster_relief.ngo.NGORepository;
import com.drms.disaster_relief.auth.repo.UserRepository;
import com.drms.disaster_relief.common.security.JWTUtill;
...
public class AuthService {
    ...
    public AuthService(AuthRepository authRepository, UserRepository userRepository, EmployeeRepository employeeRepository, NGORepository ngoRepository, PasswordEncoder passwordEncoder, BCryptPasswordEncoder bCryptpasswordEncoder, AuthenticationManager authenticationManager, JWTUtill jwtUtill) {
